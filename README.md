...
*   **Q2 2025: Proof-of-Concept:** Develop a functional prototype using publicly available longitudinal data to demonstrate the model's capabilities.
*   **Q3 2026: Pitch and Pilot Plan:** Present the proof-of-concept to the Ministry of Education and formalize the pilot program.
*   **Q4 2026: Pilot Deployment and Data Collection:** Deploy the app in selected schools and begin collecting real-world data under the Ministry's guidance.
